...
public class DBParser extends GraphParser {
    ...
    private void parseCSVData(String[] fields) {
        String SidewalkOrigLat = fields[fieldKey.get("originlat")].replace("\"","");
        String SidewalkOrigLong = fields[fieldKey.get("originlong")].replace("\"","");
        String SidewalkOrigCode = SidewalkOrigLat+SidewalkOrigLong;
        String SidewalkDestLat = fields[fieldKey.get("destlat")].replace("\"","");
        String SidewalkDestLong = fields[fieldKey.get("destlong")].replace("\"","");
        String SidewalkDestCode = SidewalkDestLat+SidewalkDestLong;
